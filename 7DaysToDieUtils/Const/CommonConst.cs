...
namespace _7DaysToDieUtils.Cons
{
    public class CommonConst
    {
        public const string DLL_NAME = "Assembly-CSharp.dll";

        public readonly static List<(string, string)> QQ_ROOMS = new List<(string, string)>
        {
            ...
            ("七日杀旧日支配者交流群: 832407093 (单机)" , QQ_ROOM_STAND_ALONE_7),
            ("八日杀旧日支配者交流群: 912561691 (单机)" , QQ_ROOM_STAND_ALONE_8),
            ("九日杀旧日支配者交流群: 240321444 (单机)" , QQ_ROOM_STAND_ALONE_9),
        };
        ...
        public const string QQ_ROOM_STAND_ALONE_7 = "https://qm.qq.com/cgi-bin/qm/qr?k=RSs7eC54_adGdTDIBVY6HupGfZQ776G6&jump_from=webapi";
        public const string QQ_ROOM_STAND_ALONE_8 = "https://qm.qq.com/cgi-bin/qm/qr?k=Ow6fEziD-nkZ8ubab3cuFO8pLJ4L8HV-&jump_from=webapi";
        public const string QQ_ROOM_STAND_ALONE_9 = "https://qm.qq.com/cgi-bin/qm/qr?k=pmYTPRBqBEmgJfpekGxZ-cz5UnQgl51j&jump_from=webapi";
    }
}
